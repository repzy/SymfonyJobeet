...
class AffiliateAdminControllerTest extends WebTestCase
{
    ...
    public function setUp()
    {
        ...
        //we have to close the connection after dropping the database so we dont get "No database selected"
    ...
    public function testActivate()
    {
        ...
        $link = $crawler->filter('.btn_edit_link')->link();
        $client->click($link);
        ...
        //Asserting the email data
        $this->assertInstanceOf('Swift_Message', $message);
        $this->assertEquals('Jobeet affiliate token', $message->getSubject());
        $this->assertRegExp('/Your secret token is symfony/', $message->getBody());
    }
}
