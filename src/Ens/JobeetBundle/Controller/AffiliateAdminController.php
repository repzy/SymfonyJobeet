...
class AffiliateAdminController extends Controller
{
    ...
    public function batchActionDeactivate(ProxyQueryInterface $selectedModelQuery)
    {
        ...
        $this->get('session')->getFlashBag()->add('sonata_flash_success', sprintf('The selected account have been deactivated'));
    ...
    public function deactivateAction($id)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $affiliate = $em->getRepository('EnsJobeetBundle:Affiliate')->findOneBy($id);
