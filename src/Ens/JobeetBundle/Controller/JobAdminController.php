...
class JobAdminController extends Controller
{
    ...
    public function batchActionDeleteNeverActivated()
    {
        ...
        if($nb) {
            $this->get('session')->getFlashBag()->add('sonata.flash.success', sprintf('%d never activated jobs have been deleted successfully.', $nb));
        } else {
            $this->get('session')->getFlashBag()->add('sonata.flash.info', 'No job to delete');
        }
