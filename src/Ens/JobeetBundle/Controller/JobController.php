...
class JobController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $feedId = shal($this->get('router')->generate('ens_job', array('_format' => 'atom'), true));
    ...
    public function showAction($id)
    {
        ...
        // store the jobs as an array so we can put in the session and avoid entity serialize errors
        $job = array(
            'id' => $entity->getId(),
    ...
    /**
     * Displays preview before editing or publishing the Job entity.
     *
     */
    ...
    /**
     * Extends active time of a Job entity.
     *
     */
    public function extendAction(Request $request, $token)
    {
        ...
        if($form->isValid()) {
            $em = $this->getDoctrine()->getManager();
            $entity = $em->getRepository('EnsJobeetBundle:Job')->findByToken($token);
    ...
    /**
     * Creates a form to publish a Job entity by token.
     *
     * @param mixed $token The entity token
     *
     * @return \Symfony\Component\Form\Form The form
    ...
    /**
     * Creates a form to extend active time a Job entity by token.
     *
     * @param mixed $token The entity token
     *
     * @return \Symfony\Component\Form\Form The form
